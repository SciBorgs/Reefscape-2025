...
/**
 * a beambreak wrapper that contains two main elements:
 * 1. A BooleanSupplier detailing the beambreak's state; true for unbroken, false for broken
 * 2. A close runnable that will close the resource if necessary
 */
public class Beambreak {
  ...
  /**
   * Generates a beambreak that does not have hardware
   * This beambreak will always return true.
   */
