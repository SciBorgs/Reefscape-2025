 ...
 *
 * <p>{@link BetterSwerveDrivePoseEstimator#update} should be called every robot loop.
 *
 * <p>{@link BetterSwerveDrivePoseEstimator#addVisionMeasurement} can be called as infrequently as
 * you want; if you never call it, then this class will behave as regular encoder odometry.
 */
public class BetterSwerveDrivePoseEstimator extends BetterPoseEstimator<SwerveModulePosition[]> {
   ...
   */
  public BetterSwerveDrivePoseEstimator(
