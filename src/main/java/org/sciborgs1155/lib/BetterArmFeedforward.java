 ...
 */
public class BetterArmFeedforward implements ProtobufSerializable, StructSerializable {
   ...
   */
  public BetterArmFeedforward(double ks, double kg, double kv, double ka, double dtSeconds) {
    this.ks = ks;
    this.kg = kg;
    this.kv = kv;
    this.ka = ka;
