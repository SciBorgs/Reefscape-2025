...
public class ArmConstants {
  ...
  public static final Angle CORAL_INTAKE_ANGLE = Radians.of(-0.76); // -0.638);
  public static final Angle PROCESSOR_OUTTAKE_ANGLE = Radians.of(0.8973787609131001);
  public static final Angle TROUGH_OUTTAKE_ANGLE = Radians.of(0.97);
  public static final Angle ALGAE_INTAKE_ANGLE = Radians.of(0.223);
