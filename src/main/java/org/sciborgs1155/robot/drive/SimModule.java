...
public class SimModule implements ModuleIO {
  private final DCMotorSim drive =
      new DCMotorSim(
          LinearSystemId.createDCMotorSystem(Driving.FRONT_LEFT_FF.kV(), Driving.FRONT_LEFT_FF.kA()), DCMotor.getKrakenX60(1));

  private final PIDController driveFeedback =
      new PIDController(Driving.PID.P, Driving.PID.I, Driving.PID.D);

  private final SimpleMotorFeedforward driveFF =
      new SimpleMotorFeedforward(Driving.FRONT_LEFT_FF.kS(), Driving.FRONT_LEFT_FF.kV(), Driving.FRONT_LEFT_FF.kA());
